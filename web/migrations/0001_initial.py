    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', models.CharField(default=b'SecondOrder', max_length=10, choices=[(b'FirstOrder', b'FirstOrder'), (b'SecondOrder', b'SecondOrder')])),
                ('status', models.CharField(default=b'enable', max_length=10, choices=[(b'enable', b'enable'), (b'disable', b'disable')])),
            ],
        ),
    ]
